...
function generateMenuData_Main()
    ...
    local mainMenuLayout = {
        ...
        { text = "Mailbox", notCheckable = 1, hasArrow = true, keepShownOnClick = 0, func = clickFunctionMenuItem, arg1 = contentFramePopulateAllMail, menuList = generateMenuData_CharacterList(nil, true, false, false, false, false, false, true) },
...
function contentFramePopulateAllMail()
    -- Get the character data
    local mailboxData = interfaceGetAllMailbox()
    -- TODO: Link the data to the UI frame
