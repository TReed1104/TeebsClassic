...
function initialiseDB()
    ...
    if TeebsClassicDB.realms[CURRENT_REALM].characters[CURRENT_CHARACTER_NAME]["sub-zone"] == nil then
        TeebsClassicDB.realms[CURRENT_REALM].characters[CURRENT_CHARACTER_NAME]["sub-zone"] = {}
    end
